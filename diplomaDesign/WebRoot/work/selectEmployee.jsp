...
<html>
	...
	<body>
		<form class="form-inline definewidth m20" action="selectEmployeeA" method="post">
			查询员工姓名：
			<input type="text" name="name" id="rolename" class="abc input-default" value="">&nbsp;&nbsp;
		...
		<table class="table table-bordered table-hover definewidth m10">
			<thead>
    			...
    			<tr>
    				...
    				<td><a href="addUserLogOne?id=${list.emp_id}">设置账号</a></td>
    			</tr>
    			</s:iterator>
		</table>
	</body>
