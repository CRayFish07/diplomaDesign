...
<html>
	...
	<body>
		<form class="form-inline definewidth m20" action="selectRoomU" method="post">
			修改房间：
		...
		<table class="table table-bordered table-hover definewidth m10">
			<thead>
    			...
    			<tr>
    				...
    				<td><a href="selectRoomById?id=${list.room_id}">修改</a></td>
    			</tr>
    			</s:iterator>
		</table>
		<label style="color:red;">修改房间异常</label>
	</body>
</html>