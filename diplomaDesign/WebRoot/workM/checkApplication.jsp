...
<html>
	...
	<body>
		<form class="form-inline definewidth m20" action="selectApplication!checkApplicationByTime" > 
			申请记录： 
			<input type="text" name="time" id="rolename" class="abc input-default" placeholder="请输入查询时间" value="">
